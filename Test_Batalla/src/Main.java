...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Size campo Jugador antes de la batalla: " + duelistaJugador.getCampo().getMonstruos().size());
		System.out.println(
				"Size campo Oponente antes de la batalla: " + duelistaJugador.getCampo().getMonstruos().size());

		// Batalla entre cartas
		batallaMonstruos.atacar(duelistaJugador.getCampo().getMonstruos().get(0),
				duelistaOponente.getCampo().getMonstruos().get(0));
		...
		System.out
				.println("Size campo Jugador luego de la batalla: " + duelistaJugador.getCampo().getMonstruos().size());
		System.out.println(
				"Size campo Oponente luego de la batalla: " + duelistaJugador.getCampo().getMonstruos().size());
		 ...
		 * 
		 * CartaMonstruo monster1 = new CartaMonstruo(1, "Dark Magician",
		 * "descripcion1", 30, 20); CartaMonstruo monster2 = new CartaMonstruo(2,
		 * "Dragon Blanco", "descripcion2", 30, 20);
		 * 
		 * monster1.setPosicionAtaque(true); monster2.setPosicionAtaque(false);
		 * 
		 * 
